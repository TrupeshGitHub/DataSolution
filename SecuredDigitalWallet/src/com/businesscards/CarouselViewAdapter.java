...
import com.example.secureddigitalwallet.R;
 ...
 public class CarouselViewAdapter extends BaseAdapter {
	...
	private Bitmap createReflectedImage(Bitmap bmp) {
    	...
    	//used Config.RGB_565, to save the memory crash... this is the reason why reflection is not coming
    	//Create a new bitmap with same width but taller to fit reflection
    	Bitmap bitmapWithReflection = Bitmap.createBitmap(width , (height + height/reflection_part), Config.RGB_565);
